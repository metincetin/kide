...
#define ORG_NAME "KDE"
#define PROJECT_NAME "kide"
#define COMPONENT_NAME "kide"
#define PROJECT_DESCRIPTION "A code editor simple by default, powerful when needed."
#define PROJECT_YEAR "2022"
#define PRODUCT_NAME "kide"
#define PROJECT_PAGE "https://kide.kde.org"
#define REPORT_PAGE "https://bugs.kde.org/enter_bug.cgi?product=kide"
...
int main(int argc, char *argv[])
{
    ...
    about.addAuthor(i18n("Metin Çetin"), i18n("Developer"), QStringLiteral("metinc309@gmail.com"));
    ...
    about.setHomepage("https://github.com/metincetin/kide");
    about.setBugAddress("https://github.com/metincetin/kide/issues");
